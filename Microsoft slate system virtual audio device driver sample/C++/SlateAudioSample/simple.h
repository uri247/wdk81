...
//
// PIN_DEVICE_FORMATS_AND_MODES Array index
//

// Render wave node device formats index.
#define AUDIO_DEVICE_FORMATS            0
#define HOST_DEVICE_FORMATS             1
#define OFFLOAD_DEVICE_FORMATS          2
#define LOOPBACK_DEVICE_FORMATS         3

// Capture wave node device formats index.
#define CAPTURE_DEVICE_FORMATS          0
