...
#define SPEAKER_LOOPBACK_MIN_SAMPLE_RATE            44100   // Min Sample Rate
...
{
    {
        ...
        &SpeakerHostPinSupportedDeviceFormats[SIZEOF_ARRAY(SpeakerHostPinSupportedDeviceFormats)-1].DataFormat   
    },
    {
