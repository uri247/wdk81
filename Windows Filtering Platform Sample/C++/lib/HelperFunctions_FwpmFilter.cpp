                                               ...
                                               _In_ const GUID* pConditionKey)
{
      ...
      *pLayerKey == FWPM_LAYER_INBOUND_IPPACKET_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionInboundIPPacket[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_OUTBOUND_IPPACKET_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionOutboundIPPacket[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_IPFORWARD_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionIPForward[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_INBOUND_TRANSPORT_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionInboundTransport[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_OUTBOUND_TRANSPORT_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionOutboundTransport[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_STREAM_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionStream[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_DATAGRAM_DATA_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionDatagramData[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_INBOUND_ICMP_ERROR_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionInboundICMPError[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_OUTBOUND_ICMP_ERROR_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionOutboundICMPError[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_RESOURCE_ASSIGNMENT_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEResourceAssignment[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_AUTH_LISTEN_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEAuthListen[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEAuthRecvAccept[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_AUTH_CONNECT_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEAuthConnect[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_FLOW_ESTABLISHED_V6_DISCARD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEFlowEstablished[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_IPSEC_KM_DEMUX_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionIPsecKMDemux[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_IPSEC_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionIPsec[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_IKEEXT_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionIKEExt[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_RPC_UM)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionRPCUM[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_RPC_EPMAP)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionRPCEPMap[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_RPC_EP_ADD)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionRPCEPAdd[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_RPC_PROXY_CONN)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionRPCProxyConn[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_RPC_PROXY_IF)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionRPCProxyIf[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_NAME_RESOLUTION_CACHE_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionNameResolutionCache[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_RESOURCE_RELEASE_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEResourceRelease[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_ENDPOINT_CLOSURE_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEEndpointClosure[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_CONNECT_REDIRECT_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEConnectRedirect[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_ALE_BIND_REDIRECT_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionALEBindRedirect[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_STREAM_PACKET_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionStreamPacket[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_KM_AUTHORIZATION)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionKMAuthorization[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_INBOUND_MAC_FRAME_ETHERNET)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionInboundMACFrameEthernet[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_OUTBOUND_MAC_FRAME_ETHERNET)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionOutboundMACFrameEthernet[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_INBOUND_MAC_FRAME_NATIVE)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionInboundMACFrameNative[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_OUTBOUND_MAC_FRAME_NATIVE)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionOutboundMACFrameNative[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_INGRESS_VSWITCH_ETHERNET)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionIngressVSwitchEthernet[conditionIndex])
         {
            isValid = TRUE;
   ...
   else if(*pLayerKey == FWPM_LAYER_EGRESS_VSWITCH_ETHERNET)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionEgressVSwitchEthernet[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_INGRESS_VSWITCH_TRANSPORT_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionIngressVSwitchTransport[conditionIndex])
         {
            isValid = TRUE;
           ...
           *pLayerKey == FWPM_LAYER_EGRESS_VSWITCH_TRANSPORT_V6)
   {
      for(UINT32 conditionIndex = 0;
          ...
          conditionIndex++)
      {
         if(pConditionKey == ppConditionEgressVSwitchTransport[conditionIndex])
         {
            isValid = TRUE;
