...
static const GUID* const ppProxyByInjection[]          = {&WFPSAMPLER_CALLOUT_PROXY_BY_INJECTION_AT_INBOUND_TRANSPORT_V4,
                                                          &WFPSAMPLER_CALLOUT_PROXY_BY_INJECTION_AT_INBOUND_TRANSPORT_V6,
...
const UINT32 EXPOSED_CALLOUT_COUNT = BASIC_ACTION_BLOCK_COUNT +
...
const UINT32 BASE_INDEX_PBI = BASE_INDEX_FSI + FAST_STREAM_INJECTION_COUNT;
const UINT32 BASE_INDEX_PBA = BASE_INDEX_PBI + PROXY_BY_INJECTION_COUNT;
const UINT32 BASE_INDEX_PND = BASE_INDEX_PBA + PROXY_BY_ALE_REDIRECT_COUNT;
