...
/**
 @private_function="PrvHlprNDISMediumTypeParse"
   ...
   Notes:                                                                                       <br>
                                                                                                <br>
   MSDN_Ref: HTTP://MSDN.Microsoft.com/En-US/Library/Windows/Desktop/FF565910.aspx              <br>
*/
                                       ...
                                       _Inout_ FWPM_FILTER* pFilter)
{
   ...
   /// These layers are currently reserved for Microsoft's internal use, and require special callout needs
       ...
       stringIndex++)
   {
                             ...
                             ppCLPStrings[stringIndex]))
      {
         ...
         else
         {
            ...
            if(IsValidSid(pSID))
            {
               UINT32 sidSize = GetLengthSid(pSID);
               PSID   pData   = 0;
