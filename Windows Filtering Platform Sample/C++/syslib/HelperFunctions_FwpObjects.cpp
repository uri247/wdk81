...
HANDLE g_IPv4InboundMACInjectionHandle              = 0;
HANDLE g_IPv4IngressVSwitchEthernetInjectionHandle  = 0;
HANDLE g_IPv4InboundForwardInjectionHandle          = 0;
HANDLE g_IPv4InboundNetworkInjectionHandle          = 0;
HANDLE g_IPv4InboundTransportInjectionHandle        = 0;
HANDLE g_IPv4InboundStreamInjectionHandle           = 0;
HANDLE g_IPv4OutboundMACInjectionHandle             = 0;
HANDLE g_IPv4EgressVSwitchEthernetInjectionHandle   = 0;
HANDLE g_IPv4OutboundForwardInjectionHandle         = 0;
HANDLE g_IPv4OutboundNetworkInjectionHandle         = 0;
HANDLE g_IPv4OutboundTransportInjectionHandle       = 0;
HANDLE g_IPv4OutboundStreamInjectionHandle          = 0;
HANDLE g_IPv6InboundMACInjectionHandle              = 0;
HANDLE g_IPv6IngressVSwitchEthernetInjectionHandle  = 0;
HANDLE g_IPv6InboundForwardInjectionHandle          = 0;
HANDLE g_IPv6InboundNetworkInjectionHandle          = 0;
HANDLE g_IPv6InboundTransportInjectionHandle        = 0;
HANDLE g_IPv6InboundStreamInjectionHandle           = 0;
HANDLE g_IPv6OutboundForwardInjectionHandle         = 0;
HANDLE g_IPv6OutboundNetworkInjectionHandle         = 0;
HANDLE g_IPv6OutboundTransportInjectionHandle       = 0;
HANDLE g_IPv6OutboundStreamInjectionHandle          = 0;
HANDLE g_IPv6OutboundMACInjectionHandle             = 0;
HANDLE g_IPv6EgressVSwitchEthernetInjectionHandle   = 0;
HANDLE g_InboundForwardInjectionHandle              = 0;
HANDLE g_InboundNetworkInjectionHandle              = 0;
HANDLE g_InboundTransportInjectionHandle            = 0;
HANDLE g_InboundStreamInjectionHandle               = 0;
HANDLE g_InboundMACInjectionHandle                  = 0;
HANDLE g_IngressVSwitchEthernetInjectionHandle      = 0;
HANDLE g_OutboundForwardInjectionHandle             = 0;
HANDLE g_OutboundNetworkInjectionHandle             = 0;
HANDLE g_OutboundTransportInjectionHandle           = 0;
HANDLE g_OutboundStreamInjectionHandle              = 0;
HANDLE g_OutboundMACInjectionHandle                 = 0;
HANDLE g_EgressVSwitchEthernetInjectionHandle       = 0;
...
/**
 @helper function="KrnlHlprFwpmLayerIsIPv4"
...
/**
 @helper function="KrnlHlprFwpmLayerIsIPv6"
