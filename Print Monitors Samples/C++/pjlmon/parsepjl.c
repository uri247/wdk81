...
void TokenFromParamValueFromNumberFF
   (_In_ ParseVarsType *pParseVars, ParamType);
void SetNewList(_In_ ParseVarsType *pParseVars,
   ParamType);
void GetTotalAndLargestFF(_In_ ParseVarsType *pParseVars,ParamType param);
void GetCodeAndOnlineFF(_In_ ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexSetNewList(_In_ ParseVarsType *pParseVars,ParamType param);
void SetValueFromParamFF(_In_ ParseVarsType *pParseVars,ParamType param);
void SetValueFromParam(_In_ ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexValueFromNumberEOLFromParam(_In_ ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexValueFromBooleanEOL(_In_ ParseVarsType *pParseVars,ParamType param);
void GetTokenFromIndexValueFromStringEOL(_In_ ParseVarsType *pParseVars,ParamType param);


/* Fuctions called when no string in a keywords list is found */
void ActionNotFoundSkipPastFF(_In_ ParseVarsType *pParseVars);
void ActionNotFoundSkipCFLFandIndentedLines(_In_ ParseVarsType *pParseVars);


/* Helper Functions */
void StoreToken(_In_ ParseVarsType *pParseVars, DWORD dwToken);
BOOL StoreTokenValueAndAdvancePointer
   (_In_ ParseVarsType *pParseVars, UINT_PTR dwValue);
void  ExpectFinalCRLFFF(_In_ ParseVarsType *pParseVars);
BOOL  SkipPastNextCRLF(_In_ ParseVarsType *pParseVars);
int GetPositiveInteger(_In_ ParseVarsType *pParseVars);
BOOL AdvancePointerPastString
   (_In_ ParseVarsType *pParseVars, _In_ LPSTR pString);
...
void SetNewList(_In_ ParseVarsType *pParseVars, ParamType param)
{
...
BOOL StoreTokenValueAndAdvancePointer(_In_ ParseVarsType *pParseVars, UINT_PTR dwValue)
{
