                              ...
                              LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(pIsochAllocateBandwidth->nMaxBytesPerFrameRequested, 
                tmpBuff, 
                            ...
                            LPARAM      lParam)
{
    ...
    switch (uMsg)
    {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(pIsochAllocateChannel->nRequestedChannel, tmpBuff, (STRING_SIZE * sizeof(CHAR)), 16);
                              ...
                              LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(pIsochAllocateResources->nChannel, tmpBuff, (STRING_SIZE * sizeof(CHAR)), 16);
            SetDlgItemText(hDlg, IDC_ISOCH_ALLOC_RES_CHANNEL, tmpBuff);

            _ultoa_s(pIsochAllocateResources->nMaxBytesPerFrame, tmpBuff, (STRING_SIZE * sizeof(CHAR)), 16);
            SetDlgItemText(hDlg, IDC_ISOCH_ALLOC_RES_BYTES_PER_FRAME, tmpBuff);

            _ultoa_s(pIsochAllocateResources->nNumberOfBuffers, tmpBuff, (STRING_SIZE * sizeof(CHAR)), 16);
            SetDlgItemText(hDlg, IDC_ISOCH_ALLOC_RES_NUM_OF_BUFFERS, tmpBuff);

            _ultoa_s(pIsochAllocateResources->nMaxBufferSize, tmpBuff, (STRING_SIZE * sizeof(CHAR)), 16);
            SetDlgItemText(hDlg, IDC_ISOCH_ALLOC_RES_MAX_BUFFER_SIZE, tmpBuff);

            _ultoa_s(pIsochAllocateResources->nQuadletsToStrip, tmpBuff, (STRING_SIZE * sizeof(CHAR)), 16);
                          ...
                          LPARAM      lParam)
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->nNumberOfDescriptors, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->R3_IsochDescriptor[0].ulLength, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->R3_IsochDescriptor[0].ulTag, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->R3_IsochDescriptor[0].CycleTime.CL_CycleOffset, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)),
                16);
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->R3_IsochDescriptor[0].CycleTime.CL_SecondCount, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->R3_IsochDescriptor[0].nMaxBytesPerFrame, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->R3_IsochDescriptor[0].ulSynch, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                (ULONG)pIsochAttachBuffers->R3_IsochDescriptor[0].CycleTime.CL_CycleCount, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
                          ...
                          LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(
                (ULONG)pIsochDetachBuffers->nNumberOfDescriptors, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
                        ...
                        LPARAM      lParam)
{
    ...
    switch (uMsg) {
        ...
        case WM_INITDIALOG:
            ...
            // put offset low and high and buffer length in edit controls
            _ultoa_s(*pChannel, tmpBuff, (STRING_SIZE * sizeof(CHAR)), 16);
                   ...
                   LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(
                pIsochListen->StartTime.CL_CycleOffset, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                pIsochListen->StartTime.CL_CycleCount, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
            ...
            _ultoa_s(
                pIsochListen->StartTime.CL_SecondCount, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)), 
                16);
                                ...
                                LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(
                pIsochSetChannelBandwidth->nMaxBytesPerFrame, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)),
                16);
                 ...
                 LPARAM      lParam)
{
    ...
    switch (uMsg) 
    {
        ...
        case WM_INITDIALOG:
            ...
            _ultoa_s(
                pIsochTalk->StartTime.CL_CycleOffset, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)),
                16);
            ...
            _ultoa_s(
                pIsochTalk->StartTime.CL_CycleCount, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)),
                16);
            ...
            _ultoa_s(
                pIsochTalk->StartTime.CL_SecondCount, 
                tmpBuff, 
                (STRING_SIZE * sizeof(CHAR)),
                16);
