...
typedef LONG (APIENTRY * PCommonPropertySheetUIWProc)(
                                HWND hWndOwner,
...

{
    ...
    PCommonPropertySheetUIWProc             pProc;
    ...
    if ((hInstCompstui = LoadLibraryA(szCompstui)) &&
        (pProc = (PCommonPropertySheetUIWProc)GetProcAddress(hInstCompstui, szCommonPropertySheetUI))) {
